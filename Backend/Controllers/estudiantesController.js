...
exports.registrarEstudianteController = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ mensaje: "Error registrando estudiante" });
  }
};
...
exports.consultarEstudianteController = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ mensaje: "Error consultando estudiante" });
  }
};
...
exports.modificarEstudianteController = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ mensaje: "Error modificando estudiante" });
  }
};
...
exports.registrarEnAsignaturaController = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ mensaje: "Error registrando en asignatura" });
  }
};
...
exports.consultarEstudiantesAsignaturaController = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ mensaje: "Error consultando asignatura" });
  }
};
